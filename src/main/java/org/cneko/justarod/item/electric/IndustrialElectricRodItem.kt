 ...
 */
class IndustrialElectricRodItem: MultiModeSelfUsedElectricRodItem(Settings().component(JRComponents.USED_TIME_MARK,0).maxDamage(100000000).component(JRComponents.SPEED,500).component(JRComponents.MODE,"normal")) {
