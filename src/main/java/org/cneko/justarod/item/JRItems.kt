...
class JRItems {
    companion object{
        ...
        val SHENBAO = Item(Item.Settings().food(FoodComponent.Builder()
            ...
            .build()))
        val _STAMINA_DRAUGHT = Item(Item.Settings().food(FoodComponent.Builder()
        ...
        fun init(){
            ...
            Registry.register(Registries.ITEM, Identifier.of(MODID, "stamina_draught"), _STAMINA_DRAUGHT)
