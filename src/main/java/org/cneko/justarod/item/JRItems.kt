...
class JRItems {
    companion object{
        ...
        val PRIMITIVE_ROD = PrimitiveEndRod()
        ...
        val SHENBAO = Item(Item.Settings().food(FoodComponent.Builder()
            ...
            .build()))
        val STAMINA_DRAUGHT = Item(Item.Settings().food(FoodComponent.Builder()
            .nutrition(1).statusEffect(StatusEffectInstance(JREffects.STRONG_EFFECT.entry(), 200,3,false,true),1f).alwaysEdible()
            .build()))
        ...
        val PLAYER_SCANNER = PlayerScannerItem()
        ...
        fun init(){
            ...
            Registry.register(Registries.ITEM, Identifier.of(MODID, "primitive_rod"), PRIMITIVE_ROD)
            ...
            Registry.register(Registries.ITEM, Identifier.of(MODID, "stamina_draught"), STAMINA_DRAUGHT)
            ...
            Registry.register(Registries.ITEM, Identifier.of(MODID, "player_scanner"), PLAYER_SCANNER)
            // 注册物品组
